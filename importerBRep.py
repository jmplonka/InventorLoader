...
from importerSegNode    import _TYP_UINT32_, _TYP_UINT32_A_, _TYP_NODE_REF_, _TYP_MAP_U32_U32_, _TYP_TRANSFORMATIONS_, _TYP_MAP_KEY_REF_
...
class BRepReader(NameTableReader):
	...
	def Read_09DABAE0(self, node):
		...
		i = node.ReadList6(i, _TYP_MAP_U32_U32_, 'lst0')
	...
	def Read_481DFC84(self, node):
		...
		i = node.ReadList2(i, _TYP_UINT32_, 'lst1')
		return i
	...
	def Read_66085B35(self, node):
		...
		i = node.ReadUInt32(i, 'dcCreatorIdx') # the creator' index in 'DC' segment
		i = node.ReadUInt16(i, 'u16_0')
		i = node.ReadList6(i, _TYP_MAP_KEY_REF_, 'lst0')
		return i
