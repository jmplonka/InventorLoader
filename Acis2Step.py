...
Acis2Step.py:
MC:
 Le classi maiuscolo sono 1-1 con le entity STEP. E' buono così si rimodella agevolmente l'object model di STEP.
...
class SHAPE_REPRESENTATION_RELATIONSHIP(REPRESENTATION_RELATIONSHIP):
	def __init__(self, repr1 = None, repr2 = None):
		...
		self.has_been_exported = True # fa parte di una listEntity
	def _getParameters(self):
		return [] # nella pratica shape_representation_relationship è sempre senza argomenti
